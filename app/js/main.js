...
marquee3000__WEBPACK_IMPORTED_MODULE_3__.init();
new _functions_modal_js__WEBPACK_IMPORTED_MODULE_2__["default"]();
const swiperBannerEl = document.querySelector("#swiper-banner");
const ourSolutionsEl = document.querySelector("#our-solutions");
if (swiperBannerEl) {
  new swiper__WEBPACK_IMPORTED_MODULE_4__["default"](swiperBannerEl, {
    slidesPerView: 1,
    spaceBetween: 8,
    pagination: {
...
if (ourSolutionsEl) {
  new swiper__WEBPACK_IMPORTED_MODULE_4__["default"](ourSolutionsEl.querySelector("#swiper-solutions"), {
    slidesPerView: 4,
    spaceBetween: 24,
    navigation: {
