export class AudioVisualize {
    ...
    setupCanvas() {
        ...
        this.barCount = Math.floor(cssWidth / (this.options.barWidth + this.options.barSpacing));
    ...
    draw() {
        ...
        for (let i = 0; i < this.processedData.length; i++) {
            ...
            const x = Math.round(i * (this.options.barWidth + this.options.barSpacing));

            const h = Math.round(barHeight);

            const y = Math.round(centerY - h / 2);

            const isPlayed = i < this.processedData.length * this.progress;
            ...
            this.roundedRect(x, y, this.options.barWidth, h, this.options.radius);
